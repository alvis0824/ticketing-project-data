...
public class RoleServiceImpl implements RoleService {
    ...
    public List<RoleDTO> listAllRoles() {
        ...
        // I already create a class called RoleMapper and there are methods for me that will make this conversion
...
//        return roleRepository.findAll().stream().map(role -> mapperUtil.convert(role, new RoleDTO.class)).collect(Collectors.toList());
    }
